...
(function($) {
    ...
    var Portlet = function(element, options) {
        ...
        this.$loaderSVG = this.$loaderSVG || $('<img src="/Content/img/progress/progress-' + this.options.progress + '-' + this.options.progressColor + '.svg" style="display:none">').appendTo(this.$element);
    }
